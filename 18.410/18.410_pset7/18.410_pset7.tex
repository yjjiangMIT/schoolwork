...
\Else{}
	...
	\For{$i=1:n$}
		\For{$v=0:w$}
			\If{$D(i-1,v)$} {$D(i,v)\gets\textup{True},E(i,v)\gets\textup{False}$}
			\ElsIf{$v\geqslant c_i$} {$D(i,v)\gets D(i-1,v-c_i),E(i,v)\gets\textup{True})$}
...
\State{$(IfExist, E)=$\Call{Decision-$k$-Bounded-Integer-Desired-Weight}{$C,w$}}
