...
\If{$C\neq\varnothing$}
	...
	\If{$IfDiscard$}
		\State{$KeepList.append(\Call{Search-Desired-Weight}{C,w})$}
	\Else{}
		\State{$KeepList.append(c)$}
		\State{$KeepList.append(\Call{Search-Desired-Weight}{C,w-c})$}
	\EndIf
\EndIf
\State\Return{$KeepList$}
\EndProcedure
\end{algorithmic}
\end{algorithm}
